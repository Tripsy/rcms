...
class ItemContentPolicy
{
     ...
     */
    public function view(User $user, ItemContent $itemContent): Response
    {
        return $itemContent->hasPermission($user)
                    ? Response::allow()
     ...
     */
    public function update(User $user, ItemContent $itemContent): Response
    {
        return $itemContent->hasRole($user, ItemContentPermissionRole::MANAGER)
                    ? Response::allow()
                    : Response::deny(__('message.exception.access_denied'));
    }
     ...
     */
    public function delete(User $user, ItemContent $itemContent): Response
    {
        return $itemContent->hasRole($user, ItemContentPermissionRole::MANAGER)
                    ? Response::allow()
                    : Response::deny(__('message.exception.access_denied'));
